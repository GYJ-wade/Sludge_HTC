...
# 代码执行部分
data = 'C:\\Users\\MI\\Desktop\\BT邀稿\\Fig-data-new1.csv'
...
for i in range(8):
    plt.subplot(2, 4, i + 1)  # facecolor="whitesmoke"
    violin_box(x, name[i + 1], name_unit[i], num_f[i])
plt.tight_layout(pad=1.2)
plt.savefig('C:\\Users\\MI\\Desktop\\BT邀稿\\Fig\\{变量}-10.jpg'.format(变量='8合1琴图'), dpi=300)
plt.show()
